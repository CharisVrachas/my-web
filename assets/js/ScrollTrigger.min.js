...
!(function (e, t) {
			...
			function lf() {
				...
				(T && (r || n) && T(se, e, t, me, ye),
					...
					n &&
						...
						(ye[0] = ye[1] = ye[2] = 0)),
					(ne || re) &&
						(z && z(se), re && (p && 1 === re && p(se), h && h(se), (re = 0)), (ne = !1)),
					oe && !(oe = !1) && Z && Z(se),
					ie && (q(se), (ie = !1)),
					(ee = 0));
			}
	...
	function Db(e, t) {
		if (ct(e)) {
			...
			(~r && (e.indexOf("%") > r && (n *= t / 100), (e = e.substr(0, r - 1))),
				(e =
					n +
					(e in U ? U[e] * t : ~e.indexOf("%") ? (parseFloat(e) * t) / 100 : parseFloat(e) || 0)));
		}
		return e;
	}
	...
	function oc(e, t, r, n, i, o, a, s, l, c, u, f, d, p) {
		...
		if ((d && d.seek(0), isNaN(e) || (e = +e), Va(e)))
			(d && (e = Fe.utils.mapRange(d.scrollTrigger.start, d.scrollTrigger.end, 0, f, e)),
				a && q(a, r, n, !0));
		else {
			Ua(t) && (t = t(s));
			var m,
		...
		if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), o)) {
			...
			((g = "scroll" + n.d2),
				q(
					...
					S,
					n,
					(T && 20 < S) || (!T && (u ? Math.max(He[g], qe[g]) : o.parentNode[g]) <= S + 1),
				),
	...
	var Fe,
		...
		ne =
				...
				if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), lt)) {
					...
					if (
						...
						ue &&
							...
							Ie.forEach(function (e) {
								return (
									Ua(e) && e.target === (me ? Ue.scrollingElement || qe : be) && (e.smooth = !1)
								);
							}),
							(p = Ua(ue.snapTo)
								? ue.snapTo
						...
						(o =
							(o =
								(oe = Te.trigger = J(oe || (!0 !== ae && ae))) && oe._gsap && oe._gsap.stRevert) &&
							o(Te)),
						(ae = !0 === ae ? oe : J(ae)),
					...
					if (
							...
							if ((!je && Te.enabled) || t)
								if (ae && e && st) xb(ScrollTrigger, "scrollEnd", Pb);
									...
									if (
										...
										Te._endClamp &&
											!rt &&
											((Te._endClamp = I || -0.001), (I = Math.min(I, Ra(be, he)))),
										(q = I - B || ((B -= 0.01) && 0.001)),
										...
										if (oe && Ae() && !de)
											for (o = oe.parentNode; o && o !== He;)
												(o._pinOffset && ((B -= o._pinOffset), (I -= o._pinOffset)),
													(o = o.parentNode));
									} else
										((i = nb(ae)),
											(s = he === Xe),
									...
									(p &&
										...
										(x || Oe !== Te.progress || de || le || (O && !O._initted)) &&
											(O &&
												...
												O.totalProgress(
													de && B < -0.001 && !Oe ? Fe.utils.normalize(B, I, 0) : Oe,
													!0,
												),
						...
						(Te.labelToScroll = function (e) {
							return (
								(O && O.labels && (B || Te.refresh() || B) + (O.labels[e] / O.duration()) * q) || 0
							);
						}),
										...
										a && !je
											? (ve &&
												...
												pe &&
													...
													(Xa(Te.callbackAnimation),
													ee ? ee.progress(1) : Xa(O, "reverse" === o ? 1 : !d, 1)))
											: ve && T && !je && T(Te));
								}
								if (x) {
						...
						(Te.setPositions = function (e, t, r, n) {
							...
							(Te.refresh(
								!1,
								!1,
								{ start: Ea(e, r && !!Te._startClamp), end: Ea(t, r && !!Te._endClamp) },
								n,
							),
								Te.update());
						}),
			...
			(ScrollTrigger.register = function register(e) {
				return (
					s || ((Fe = e || La()), Ka() && window.document && ScrollTrigger.enable(), (s = lt)),
					s
				);
			}),
	...
	((ne.version = "3.15.0"),
		...
		(ne.batch = function (e, t) {
			...
			var r,
				...
				a = t.batchMax || 1e9;
			for (r in t)
				i[r] = "on" === r.substr(0, 2) && Ua(t[r]) && "onRefreshInit" !== r ? Mp(0, t[r]) : t[r];
			return (
				Ua(a) &&
					((a = a()),
	...
	function Dc(e) {
		...
		return (
			...
			(e.onChange = function (e, t, r, n, i) {
				if (
					(Mt !== l && Mq(), t && f && m(T(n[2] === t ? c + (e.startX - e.x) : m() + t - n[1])), r)
				) {
					b.offset && Nq();
					var o = i[2] === r,
